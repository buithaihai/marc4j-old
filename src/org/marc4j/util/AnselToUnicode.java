...
/**
 * This is a utility to convert MARC-8 data to UCS/Unicode.   </p>
 *
...
public class AnselToUnicode {
    ...
    /** Escape character. */
    private static final char ESCAPE = 0x001B;

    /** Redesignate default character set.  */
    private static final char REDESIGNATE = 0x0073;

    /** Designate greek symbols. */
    private static final char GREEK = 0x0067;

    /** Designate subscript characters. */
    private static final char SUBSCRIPT = 0x0070;

    /** Designate superscript characters. */
    private static final char SUPERSCRIPT = 0X062;
